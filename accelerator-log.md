...
```json
{
  ...
  "repositoryPrefix" : "harbor.h2o-4-1222.h2o.vmware.com/acme-devs"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [tanzu-java-web-app->hello-world]
┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.merge.transformations[0].sources[1].<combo>.transformations[2] (ReplaceText)
┃ ┃ ┃ ┃ ┗ ┗  Info Will replace [your-registry.io/project->harbor.h2o-4-1222.h2...(truncated)]
